      ...
      body: ListView(
        ...
        children: [
          ...
          _SwitchTile(
            ...
            onChanged: (v) { setState(() => _thinkingEnabled = v); _config.set('thinkingEnabled', v); },
          ),
          _SwitchTile(
            ...
            value: _thinkingShow,
            onChanged: (v) { setState(() => _thinkingShow = v); _config.set('thinkingShow', v); },
          ),
          _SwitchTile(
            ...
            subtitle: '后台有回复时及时提醒',
            value: _pushEnabled,
            onChanged: (v) { setState(() => _pushEnabled = v); _config.set('pushEnabled', v); },
          ),
